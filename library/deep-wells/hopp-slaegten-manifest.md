...
Version 1.5 | 2026-08-08 | Production
...
- **Phase 2 — 01f:** the full 91 pages (Knud Knudsen Hopp, d.1762) — the largest single file received so far. Started 2026-08-08, "our line" cap applied from the start (unlike 01C). Checkpoints 1-3 (Knud Knudsen Hopp himself, replacing the earlier stopgap stub; branches "a." Mogens's counterfeiting scandal, "b.," and "c.") done. Branches "d." (11 children) and "e." (2 children) remain — see `projects/archive-digitization/context/hopp-slaegten-01f-extraction.md`.
