...
- **Media:** library/deep-wells/boe-slaegten-fra-mors-og-fur-2024-media/ (images extracted from the source — own manifest, 48 embedded images found, all 48 checked, 47 filed — only image18, a confirmed exact duplicate, is not stored)
