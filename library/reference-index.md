...
Version 1.35 | 2026-08-09 | Production
...
- **Referenced by domains:** `knowledge/domains/boe-slaegten/knowledge.md` (2026-08-09). **The entire manuscript has now been mined**, across five extraction notes files: `boe-slaegten-chapter1-extraction.md` through `...-chapter4-extraction.md`, plus `...-anetavler-kilder-extraction.md` for the pedigree appendices and bibliography.
...
- **Referenced by domains:** `knowledge/domains/boe-slaegten/knowledge.md` (2026-08-09, via generation 02's Kyssesekten narrative).
...
- **Referenced by domains:** `knowledge/domains/boe-slaegten/knowledge.md` (2026-08-09, §7 comparative research).
...
- **Referenced by domains:** `knowledge/domains/hopp-slaegten/knowledge.md` (2026-08-09). Chapters 01, 01C, 01F, 02, 03, 04 all now fully read — see the Extraction log below.
...
| 1.35 | 2026-08-09 | Phase 3 domain promotion: updated `Referenced by domains` on 4 entries (`boe-slaegten-fra-mors-og-fur`, `ejerslev-1970-religios-bevaegelse-i-jorsby`, `forskellige-boe-slaegter`, `hopp-slaegten`) — all now point to the two new real domains, `knowledge/domains/boe-slaegten/` and `knowledge/domains/hopp-slaegten/`. The `hopp-slaegten` entry's field was also stale ("not read") — corrected to reflect all six chapters being fully read. |
