...
- [x] **Individual/family extraction plan (decided 2026-08-05, started 2026-08-06):** `family-tree/tree.ged` created and built incrementally, one generation/branch/chapter at a time as each is read. All four numbered chapters are now fully read: Chapter 1 (generations "02"-"05" plus the full Efterslægt, p.3-54), Chapter 2 (Boe-slægten, Jørsby, p.55-65 — Sidsel Lauridsdatter Toft's own ancestry), Chapter 3 (Vester Vandet, p.66-73 — Mette Jensdatter's own ancestry, the Møller/miller family), Chapter 4 (Boe-slægten Thy, p.74 — confirmed a cross-reference to Chapter 3, no new individuals). 334 individuals / 106 families, append-only IDs per `context/data-structure-proposal.md` §4.1. Extraction notes split one file per chapter (`context/boe-slaegten-chapter1-extraction.md` through `...-chapter4-extraction.md`). Remaining: the Anetavler appendices (p.75-91 — Søgaard-slægten, Lundgaard-slægten/Fur-slægter, Degn-slægten Frammerslev/Fur, plus comparative notes on unrelated "Boe" families elsewhere in Denmark) and Kilder (bibliography, p.92-96).
