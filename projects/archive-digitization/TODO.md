...
- [x] **Individual/family extraction plan (decided 2026-08-05, started 2026-08-06):** `family-tree/tree.ged` created and built incrementally, one generation/branch/chapter at a time as each is read. Chapter 1 (generations "02"-"05" plus the full Efterslægt, p.3-54) and Chapter 2 (Boe-slægten, Jørsby, p.55-65 — Sidsel Lauridsdatter Toft's own ancestry) are now fully read: 301 individuals / 100 families, append-only IDs per `context/data-structure-proposal.md` §4.1. Extraction notes now split one file per chapter (`context/boe-slaegten-chapter1-extraction.md`, `context/boe-slaegten-chapter2-extraction.md`) rather than one ever-growing file. Chapters 3-4 (Vester Vandet/Møller family, Boe-slægten Thy) and the anetavle appendices (Søgaard-slægten, Lundgaard-slægten/Fur-slægter, Degn-slægten Frammerslev/Fur, plus comparative notes on unrelated "Boe" families) and Kilder (bibliography) remain unread.
