...
| 1.5 | 2026-08-25 | Upstream sync from `proto-context-architecture`. §8 clarified that `[SENSITIVE]` is a post-hoc documentation tag, not a gate; cross-referenced the pause-and-ask Hard Constraint in `ROUTING.md` that governs whether sensitive content gets written down in the first place. |
