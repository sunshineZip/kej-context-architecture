...
> **Sprog:** Denne fil er bevidst skrevet på dansk — det er KEJs sprog, og det er sproget forskningen selv foregår på. Undtagelser: overskriften "## Version History" og linjen "Version | Dato | Status" ovenfor følger arkivets almindelige (engelske) konvention, så `scripts/validate.ps1` fortsat kan genkende og kontrollere dem.

## Dokumentets Formål

Løbende liste over opdagelser, foreslåede forbindelser, tilsyneladende uoverensstemmelser og datahuller, som dette arkiv selv har bemærket — endnu ikke gennemgået af KEJ (Knud Erik Jakobsen). Intet her er fastslået. Se `knowledge/flow/operating-principles.md` §5 (Flag til KEJs gennemgang) for flagformatet, og `log.md` for den fortløbende historik over tidligere oversigter og hans svar.

**Sådan bruges filen:** med jævne mellemrum (forslag: månedligt, men i dit eget tempo — ikke automatiseret) kopieres punkterne nedenfor ind i en mail eller besked til KEJ. Når han svarer, flyttes hvert punkt til `log.md` sammen med hans svar — og kun for bekræftede punkter skrives fundet ind i det pågældende slægtsdomænes `knowledge.md` med `[VERIFIED: KEJ, ÅÅÅÅ-MM-DD]`. Slet ikke punkter herfra, uden først at have registreret dem i `log.md`.
...
**Fund:** En ekstern slægtsforskningsside (akj-cbj.dk/Hopp.htm, af Arne Bjørn Jørgensen) beskriver en Knud Danielsen Hopp (f. o. 1640, d. 1723, herredsfoged i Salling Nørre Herred) og hans søn Knud Knudsen Hopp (d. 1762) — fødsels-/dødsår stemmer nøjagtigt overens med KEJs egne kapitler "01 Knud Danielsen Hopp o.1640-1723" og "01F Knud Knudsen Hopp død 1762".
**Grundlag:** To uafhængige, sekundære fremstillinger, der stemmer overens om navne og årstal. Siden citerer selv KEJs egne artikler fra 1978 og 1991 som sin primærkilde — så dette er måske blot hans eget arbejde, der spejles tilbage, og ikke nødvendigvis nyt for ham.
**Status:** Foreslået — endnu ikke gennemgået af KEJ. Værd også at spørge, om han stadig selv har de to artikler fra 1978/1991.
...
**Fund:** Den eksterne side nævner tre generationer før "01": Hans Hop (1562-1624, Metzingen → Skagen), Mads Hopp (1590-1650, rådmand i Skagen) og Daniel Madsen Hopp (f. o. 1620 eller 1633, usikkert) — ingen af disse optræder i KEJs egen liste over Hopp-slægtens kapitler, som sendt indtil videre.
...
**Opdatering (2026-08-09):** Nikolaj har udviklet dette til to navngivne, dokumenterede hypoteser (en tredje — at Knud Danielsen Hopp kunne være Mads Hops egen søn direkte, uden om Daniel — blev overvejet og siden forkastet, primært fordi patronymet "Danielsen" forudsætter en far, der faktisk hed Daniel) — se `projects/archive-digitization/context/hopp-slaegten-pre-1640-hypothesis.md`. Kort fortalt: (1) Mads Hop som den fælles stamfar til flere Hopp-grene i Nord-/Midtjylland, ikke kun vores egen; (2) at fødselsåret 1633 for Daniel Madsen Hopp simpelthen er en fejlregistrering, og at han reelt er født tidligere. **Direkte spørgsmål til dig:** er du selv nået frem til nogen af disse, uden at have skrevet det ned nogen steder? Og kender du i givet fald til kirkebøger eller skifter, der kunne be- eller afkræfte dem — særligt Daniel Madsen Hopps fødselsår, eller Knud Danielsen Hopps egen dåb (formodentlig Ålborg-egnen, o. 1640)?
...
**Status:** Besvaret af KEJ (2026-08-08) med en fyldig redegørelse for sin egen opfølgning på spørgsmålet gennem årene. Den grundlæggende uoverensstemmelse (familietradition vs. den formelle "udlagt barnefader"-angivelse) forbliver reelt uafklaret — ingen af siderne er endeligt be- eller afkræftet. De konkrete detaljer i KEJ's redegørelse er efter hans eget udtrykkelige ønske ikke gengivet her — se `restricted/tree-sensitive.ged#I164` (kræver adgang til den private modul-repo).
...
| 1.21 | 2026-08-09 | Item 2 updated with a pointer to the new `projects/archive-digitization/context/hopp-slaegten-pre-1640-hypothesis.md` — three hypotheses Nikolaj developed independently of KEJ's own material (Mads Hop as a regional surname founder; the 1633 birth year for Daniel Madsen Hopp being a recording error; the lower-confidence idea that Knud Danielsen Hopp could be Mads Hop's direct son) — and a direct question asking whether KEJ has reached any of these himself, and whether he knows of primary records that could settle them. |
| 1.22 | 2026-08-09 | Item 2's third hypothesis (Knud as Mads Hop's direct son) discarded by Nikolaj after reviewing the patronymic-naming argument against it — question to KEJ narrowed to the two remaining hypotheses, with a brief note that the third was considered and dropped. |
