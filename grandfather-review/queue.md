...
Dette punkt vedrørte et familieforhold, som KEJ efterfølgende har bedt om aldrig bliver offentliggjort eller optaget i slægtsbogen. Spørgsmålet er besvaret af KEJ og arkiveret i den private modul-repo — se `restricted/tree-sensitive.ged#I164` (kræver adgang). Nummereringen er bevidst bevaret uændret her for at undgå forvirring med punkt 11 og frem.
...
| 1.9 | 2026-08-06 | Added item 10, a new category (family tradition vs. source, not an internal manuscript inconsistency) — see restricted/ for detail. |
